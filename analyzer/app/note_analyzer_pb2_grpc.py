...
import note_analyzer_pb2 as note__analyzer__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in note_analyzer_pb2_grpc.py depends on'
...
class NoteAnalyzerServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_NoteAnalyzerServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'noteanlyzer.NoteAnalyzer', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('noteanlyzer.NoteAnalyzer', rpc_method_handlers)


 # This class is part of an EXPERIMENTAL API.
class NoteAnalyzer(object):
    """Missing associated documentation comment in .proto file."""
