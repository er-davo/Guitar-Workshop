...
type NoteEvent struct {
	...
	MidiPitch       int32                  `protobuf:"varint,2,opt,name=midi_pitch,json=midiPitch,proto3" json:"midi_pitch,omitempty"`
...
const file_note_analyzer_proto_rawDesc = "" +
	...
	"\fNoteAnalyzer\x12?\n" +
	"\aAnalyze\x12\x19.noteanlyzer.AudioRequest\x1a\x19.noteanlyzer.NoteResponseB\x19Z\x17contracts/note-analyzerb\x06proto3"
