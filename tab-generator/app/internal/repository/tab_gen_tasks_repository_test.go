...
func TestGenTaskRepository_TryUpdateStatus(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name:          "success single from status",
			initialStatus: models.StatusPending,
			fromStatuses:  []models.Status{models.StatusPending},
			toStatus:      models.StatusProcessing,
			expectUpdated: true,
			expectStatus:  models.StatusProcessing,
		},
		{
			name:          "success when status in list",
			initialStatus: models.StatusPending,
			fromStatuses:  []models.Status{models.StatusProcessing, models.StatusPending},
			toStatus:      models.StatusProcessing,
			expectUpdated: true,
			expectStatus:  models.StatusProcessing,
		},
		{
			...
			fromStatuses:  []models.Status{models.StatusProcessing},
		...
		{
			name:          "wrong from statuses",
			initialStatus: models.StatusPending,
			fromStatuses:  []models.Status{models.StatusProcessing, models.StatusDone},
			toStatus:      models.StatusDone,
			expectUpdated: false,
			expectStatus:  models.StatusPending,
		},
		{
			name:          "empty from statuses",
			initialStatus: models.StatusPending,
			fromStatuses:  []models.Status{},
			toStatus:      models.StatusProcessing,
			expectUpdated: false,
